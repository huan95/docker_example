...
<div class="alignment">
    <nav class="navbar navbar-expand-sm nav">
        <a href="https://www.docker.com/" target="_blank"><img class="logoDocker"
                                                               src="{{asset('img/Docker-Logo.png')}}"></a>
    </nav>
</div>
<div class="container">
    <div class="alignment">
        <h4><i>I.Docker là gì</i></h4>
    ...
    <div class="alignment">
        <h4><i>II. Docker container là gì</i></h4>
    ...
    <div class="alignment">
        <h4><i>III. Docker images là gì</i></h4>
    ...
    <div class="alignment">
        <h4><i>IV. Ưu điểm của Docker</i></h4>
        <div class="left">
    ...
    <div class="alignment">
        <h4><i>V. So sánh Docker và Vagrant</i></h4>
    ...
    <div class="alignment">
        <h4><i>VI. Docker Compose là gì</i></h4>
    ...
    <div class="alignment">
        <h4><i>VII. Mô tả khái quát 1 file cấu hình Docker-compose</i></h4>
